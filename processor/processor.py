...
class Processor(IO):
    ...
    def get_parser(add_help=False):
        ...
        # model
        parser.add_argument('--sparse', type=str2bool, default=True, help='print logging or not')
        parser.add_argument('--model', default=None, help='the model will be used')
        parser.add_argument('--model_args', action=DictAction, default=dict(), help='the arguments of model')
        parser.add_argument('--weights', default='F:/mv-ignet/weights/xview/xview_HPGNet_epoch120_model.pt', help='the weights for network initialization')
